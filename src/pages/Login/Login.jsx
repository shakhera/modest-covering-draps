     ...
     <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white shadow-xl  font-sans mx-auto">
        ...
        <form action="" className="space-y-6">
            <div className="space-y-2 text-sm">
                ...
                <input type="email" name="email" id="email" placeholder="User email" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
            </div>
            <div className="space-y-2 text-sm">
