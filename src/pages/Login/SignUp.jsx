      ...
      <div className="pt-6 lg:pt-24 mb-6">
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white shadow-xl font-sans mx-auto dark:bg-black">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            {/* Sign in Button */}
            <button className="text-lg rounded-xl relative p-[10px] block w-full border-red-800 font-extrabold border-y-4 duration-500 overflow-hidden focus:border-indigo-500 group">
              Sign Up
